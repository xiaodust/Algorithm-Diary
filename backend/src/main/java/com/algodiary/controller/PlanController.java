...
public class PlanController {
    ...
    public PlanController(PlannerService planner, ProblemListService listService, AnalyzerService analyzer, AlgoStore store, DailyPlanService dailyPlanService) {
    ...
    public DailyPlan today() {
        ...
        DailyPlan plan = planner.plan(active, problems, states, mistakeSlugs, weakTopics, Instant.now());
        store.savePlan(plan);
        return plan;
    }
